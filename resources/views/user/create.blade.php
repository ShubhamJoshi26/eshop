      ...
      <div class="row g-3">
          ...
          <div class="row mb-2">
            ...
            <div class="col-md-3 d-flex align-items-end">
              <div class="avatar me-2">
                <span id="nameInitials" class="avatar-initial rounded-circle bg-success">UN</span>
                <img id="avatarImage" width="35px" src="" alt="" class="rounded" style="display: none">
              </div>
            </div>
          </div>
        </div>
        ...
        <div class="col-md-6 form-password-toggle">
          ...
          <div class="input-group input-group-merge">
            ...
            <span class="input-group-text cursor-pointer"><i class="mdi mdi-eye-off"></i></span>
          </div>
        </div>
      </div>
    </div>
        ...
        toggler.forEach(el => {
          el.addEventListener('click', e => {
            ...
            if (formPasswordToggleInput.getAttribute('type') === 'text') {
              ...
              formPasswordToggleIcon.classList.replace('mdi-eye', 'mdi-eye-off')
            } else if (formPasswordToggleInput.getAttribute('type') === 'password') {
              formPasswordToggleInput.setAttribute('type', 'text')
              formPasswordToggleIcon.classList.replace('mdi-eye-off', 'mdi-eye')
            }
          })
        })
      }
